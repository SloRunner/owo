...
In order to support loading of multiple wallets in oneworld-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is oneworld.cpp.
...
Changes to oneworld.cpp
----------------------
oneworld.cpp is the entry point into oneworld-qt, and as such, will require some minor modifications to provide hooks for

...
git clone https://github.com/OneWorldCoin/owo.git
cd oneworld
...
```bash
    ...
    From https://github.com/OneWorldCoin/owo
...
For example:
```bash
URL=https://github.com/OneWorldCoin/owo.git
...
[OneWorldCoin/gitian.sigs](https://github.com/OneWorldCoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.

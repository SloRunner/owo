...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OneWorld features */
        {"oneworld", "masternode", &masternode, true, true, false},
        ...
        {"oneworld", "mnbudget", &mnbudget, true, true, false},
...
#ifdef ENABLE_WALLET
        {"oneworld", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use oneworldd, or the -server option to oneworld-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"

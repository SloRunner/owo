...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 ONEWORLD at the same time
...
enum ZerocoinSpendStatus {
    ZONEWORLD_SPEND_OKAY = 0,                            // No error
    ZONEWORLD_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZONEWORLD_WALLET_LOCKED = 2,                         // Wallet was locked
    ZONEWORLD_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZONEWORLD_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZONEWORLD_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZONEWORLD_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZONEWORLD_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZONEWORLD_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZONEWORLD_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZONEWORLD_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZONEWORLD_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZONEWORLD_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZONEWORLD_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZONEWORLD_SPENT_USED_ZONEWORLD = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZOneWorldAutoBackups(bool fEnabled)
    {

...
#include "ui_zoneworldcontroldialog.h"
...
std::list<std::string> ZOneWorldControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZOneWorldControlDialog::listMints;
...
void ZOneWorldControlDialog::updateLabels()
{
    ...
    privacyDialog->setZOneWorldControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZOneWorldControlDialog::GetSelectedMints()
{
